//
//  XCamCoreSession + XCamCoreSessionRepresentable.swift
//  
//
...
/// `XCamCoreSessionRepresentable` defines a set of requirements for classes or
...
public protocol XCamCoreSessionRepresentable {
...
extension XCamCoreSession: XCamCoreSessionRepresentable {
    // MARK: - Vars
    ...
    func addMovieInput() throws {
        ...
        guard let videoDevice = AVCaptureDevice.default(for: AVMediaType.video) else {
            throw XCamError.device(reason: .unableToSetInput)
        }
    ...
    func addMovieFileOutput() throws {
        ...
        guard self.canAddOutput(fileOutput) else {
            throw XCamError.device(reason: .unableToSetOutput)
        }
